...
LRT_RREGISTRY_ENTRYDETAIL_ARR(Uint8) = {
  { "MVMT_MOTOR_FL_CURRENT_LEFT",
    "Measured Voltage above sensFET current shunt FL-left.",
    "",
    0,
    0,
    255 },
  { "MVMT_MOTOR_FL_CURRENT_RIGHT",
    "Measured Voltage above sensFET current shunt FL-right.",
    "",
    0,
    0,
    255 },
  { "MVMT_MOTOR_FR_CURRENT_LEFT",
    "Measured Voltage above sensFET current shunt FR-left.",
    "",
    0,
    0,
    255 },
  { "MVMT_MOTOR_FR_CURRENT_RIGHT",
    "Measured Voltage above sensFET current shunt FR-right.",
    "",
    0,
    0,
    255 },
  { "MVMT_MOTOR_RL_CURRENT_LEFT",
    "Measured Voltage above sensFET current shunt RL-left.",
    "",
    0,
    0,
    255 },
  { "MVMT_MOTOR_RL_CURRENT_RIGHT",
    "Measured Voltage above sensFET current shunt RL-right.",
    "",
    0,
    0,
    255 },
  { "MVMT_MOTOR_RR_CURRENT_LEFT",
    "Measured Voltage above sensFET current shunt RR-left.",
    "",
    0,
    0,
    255 },
  { "MVMT_MOTOR_RR_CURRENT_RIGHT",
    "Measured Voltage above sensFET current shunt RR-right.",
    "",
    0,
    0,
    255 },
